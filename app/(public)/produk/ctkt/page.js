...
export default async function ProdukCTKTPage() {
  let produkKWT = [];
  
  try {
    const res = await fetch(`${process.env.NEXT_PUBLIC_SITE_URL}/api/produk?lembaga_id=4`);
      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="bg-[#f7f6ee] rounded-xl shadow p-6 sm:p-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-8 text-center">
            Produk Central Training Karya Tanjung
          </h2>
            ...
            <>
              ...
              <div className="mt-12 text-center">
                <p className="text-lg font-medium text-gray-800 mb-4">
                  Tertarik dengan produk-produk CTKT? Silakan hubungi narahubung di bawah:
                </p>
                <a 
